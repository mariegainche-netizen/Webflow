...
## Méthode de travail (demande de Marie, 25/09/2026)

- Regrouper les opérations : actions groupées dans un même appel, appels indépendants lancés en parallèle. Regrouper aussi les questions en une seule. Marie ne doit pas valider des demandes à la chaîne.
- Ne solliciter Marie que pour les actions à fort impact : publication ou dépublication (site, fiches CMS), suppressions (fiches, champs, classes, variables, polices, ressources), code global du site, webhooks. Les lectures et les modifications de brouillon (Designer, CMS) se font sans lui poser de question.
